# Generated by Django 3.1.6 on 2021-03-05 08:49
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('studentreg', '0005_auto_20210228_1449'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dining', models.CharField(blank=True, choices=[('TIMELY', 'TIMELY'), ('ORDERLINESS', 'ORDERLINESS'), ('CALMNESS', 'CALMNESS'), ('PARKING OFPLATES', 'MAGRIB'), ('ALLERGY', 'ALLERGY')], max_length=255, null=True)),
